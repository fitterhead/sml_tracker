    ...
    <div className="login-gate">
      <div className="login-card">
        ...
        <div className="login-note">
          <span>Manager: reviews work and checks items as manager.</span>
          <span>Staff: updates work and checks items as staff.</span>
        </div>
        <div className="login-actions">
          <button type="button" onClick={() => login(name, 'manager')}>
            Enter as Manager
          </button>
          <button
            type="button"
            className="secondary"
            onClick={() => login(name, 'staff')}
          >
            Enter as Staff
          </button>
        </div>
